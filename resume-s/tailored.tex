...
\section{Professional Summary} \\[1mm]
    ...
    {Computer Engineering student with skills in full-stack web development using React.js, JavaScript, and backend technologies like FastAPI. Experienced in building interactive web applications, dashboards, and user-friendly interfaces. Eager to apply web development expertise to create engaging online classes and content for students learning full-stack development.}
...
\section{Projects} 
    ...
    \resumeProjectHeading
         ...
         {\textbf{DriftRadar} $|$ \emph{\href{https://github.com/bhardwaj-yash1/DriftRadar}{Source Code}}}{ReactJS $|$ FastAPI $|$ JavaScript $|$ PostgreSQL}
         \\[5mm]
          \resumeItemListStart
             % Detail 1: What did you DO and what was the RESULT? (Action verb: Developed...)
             \resumeItem{Developed a full-stack web application for real-time data monitoring, focusing on interactive frontend and backend integration.}
             % Detail 2: What TECHNOLOGIES did you use for the core logic? (Action verb: Built...)
             \resumeItem{Built a FastAPI REST backend with PostgreSQL database integration and a React.js frontend for dynamic visualization and user interaction.}
             % Detail 3: What about DEPLOYMENT/PROCESS? (Action verb: Containerized...)
             \resumeItem{Containerized the application with Docker for scalable deployment, enabling efficient troubleshooting and alignment with development practices.}
          \resumeItemListEnd
           \vspace{-20pt}
    ...
    \resumeProjectHeading
          % Project Name, Linked Source Code
          {\textbf{Animal Disease Detection Model} $|$ \emph{\href{https://github.com/bhardwaj-yash1/AnimalDisease}{Source Code}}}{Python $|$ Streamlit $|$ JavaScript $|$ Scikit-learn}
          \\[5mm]
          \resumeItemListStart
             \resumeItem{Implemented an interactive web application using Streamlit for user-friendly clinical decision support and data analysis.}
             \resumeItem{Applied data preprocessing and feature engineering with Pandas and Scikit-learn, integrating models for efficient predictions.}
             \resumeItem{Deployed the web interface to support real-time queries and visualizations, emphasizing maintainable code and user engagement.}
          \resumeItemListEnd
    ...
    \resumeProjectHeading
    % Project Name, Linked Source Code
    {\textbf{FAQ Bot for Discord} $|$ \emph{\href{https://github.com/bhardwaj-yash1/FAQBot}{Source Code}}}{Python $|$ JavaScript $|$ Scikit-learn $|$ NLTK}
    \\[5mm]
    \resumeItemListStart
    \resumeItem{Designed an interactive application with natural language processing for real-time query handling and user support.}
    \resumeItem{Trained models using Scikit-learn and NLTK for intent classification, integrating with APIs for dynamic responses.}
    \resumeItem{Developed automated systems with debugging practices to ensure reliable, engaging user interactions.}
...
\begin{tabularx}{\linewidth}{@{} p{5.4cm} X @{}} % Defines two columns, the first is fixed width, the second auto-fills
    ...
    \textbf{Web Development} & React.js, Streamlit, FastAPI, REST API, HTML, CSS \\
