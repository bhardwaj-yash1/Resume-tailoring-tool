...
\section{Professional Summary} \\[1mm]
    ...
    {Computer Engineering student with hands-on experience in full-stack web development using React.js, JavaScript, and backend technologies like FastAPI. Proven ability to build interactive applications, dashboards, and user interfaces for data visualization and real-time interactions. Eager to apply these skills in conducting engaging online full-stack classes for students aged 10-16 and contributing to content development, including notes, flashcards, and LMS materials.}
...
\section{Education} \\[1mm]
 \resumeSubHeadingListStart
    \resumeSubheading
      {IIIT Bhubaneswar}{|Expected Graduation: Aug 2027}
 ...
 \resumeSubHeadingListEnd
    \resumeItemListStart
        ...
        \resumeItem {Courses: Data Structures and Algorithms, Object Oriented Programming, Database Management Systems, Computer Architecture, Linear Algebra}
    \resumeItemListEnd
    \vspace{-22pt}
...
\section{Projects} 
    ...
    \resumeProjectHeading
         ...
         {\textbf{DriftRadar} $|$ \emph{\href{https://github.com/bhardwaj-yash1/DriftRadar}{Source Code}}}{ReactJS $|$ FastAPI $|$ Docker $|$ PostgreSQL}
         \\[5mm]
          \resumeItemListStart
             % Detail 1: What did you DO and what was the RESULT? (Action verb: Developed...)
             \resumeItem{Developed a full-stack MLOps platform with interactive dashboard for real-time data and model monitoring, enabling user-friendly visualization and analysis.}
             % Detail 2: What TECHNOLOGIES did you use for the core logic? (Action verb: Built...)
             \resumeItem{Built a FastAPI REST backend with PostgreSQL database integration and a React.js frontend for dynamic, responsive user interfaces.}
             % Detail 3: What about DEPLOYMENT/PROCESS? (Action verb: Containerized...)
             \resumeItem{Containerized the application with Docker for scalable deployment, supporting troubleshooting, maintainable code, and alignment with CI/CD practices.}
          \resumeItemListEnd
           \vspace{-20pt}
    ...
    \resumeProjectHeading
          % Project Name, Linked Source Code
          {\textbf{Animal Disease Detection Model} $|$ \emph{\href{https://github.com/bhardwaj-yash1/AnimalDiseaseDetection}{Source Code}}}{Python $|$ Scikit-learn $|$ Pandas $|$ Streamlit $|$ SHAP}
          \\[5mm]
          \resumeItemListStart
             \resumeItem{Implemented a web-based application using Streamlit for interactive clinical decision support, processing 43k+ records with 92% accuracy.}
             \resumeItem{Applied data preprocessing and feature engineering with Pandas and Scikit-learn, integrating with explainable AI via SHAP for interpretable predictions.}
             \resumeItem{Deployed the Streamlit application to support user queries and visualizations, focusing on efficient data handling and documentation for educational use.}
          \resumeItemListEnd
    ...
    \resumeProjectHeading
    % Project Name, Linked Source Code
    {\textbf{FAQ Bot for Discord} $|$ \emph{\href{https://github.com/bhardwaj-yash1/FAQBot}{Source Code}}}{Python $|$ Scikit-learn $|$ Discord.py $|$ NLTK}
    \\[5mm]
    \resumeItemListStart
    \resumeItem{Designed an interactive bot application with NLP pipeline for real-time query handling and user support in a Discord environment.}
    \resumeItem{Trained models using Scikit-learn and NLTK for intent classification with 85% accuracy, processing natural language inputs efficiently.}
    \resumeItem{Developed automated response systems with debugging and code review practices to ensure reliable, 24/7 interactive performance.}
...
\begin{tabularx}{\linewidth}{@{} p{5.4cm} X @{}} % Defines two columns, the first is fixed width, the second auto-fills
    \textbf{Programming \& Databases} & Python, SQL, JavaScript, PostgreSQL, C++ \\
